...
namespace Nexia.Diagnostics;

/// Create and cache a logger instance using the same
/// configuration sources .
///Type of the class using the logger. The type name
/// is used to decorate log entries, providing information about the log source.
...
public static class DefaultLogger
{
    ...
    private static bool TryGetLogLevel(string? value, out LogLevel level)
    {
        ...
        throw new NotSupportedException($"Logger: log level '{value}' not supported");
    }
}